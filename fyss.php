...
<head>
  <meta charset="utf-8">
  <title>FIRST YEAR SECOND SHIFT</title>
  ...
  <meta name="author" content="">
	...
	<link href="/TTMS_GP_MUMBAI/css/style.css" rel="stylesheet">
		...
		<div class="col-md-12 column">
			<table class="table table-bordered maintbl">
				...
				<tr>
					...
					<td colspan="2" ><table style="border-collapse: collapse; width:100%"><tr><td style= "border-bottom: 1px solid #ddd;" class="slot-3 slot-PL3A"><span class="slot-name"></span><div class="slot-deets"><span class="course-name"></span><div class="course-venue"></div></div>A</td></tr><tr><td style= "border-bottom: 1px solid #ddd;" class="slot-4 slot-PL4B"><span class="slot-name"></span><div class="slot-deets"><span class="course-name"></span><div class="course-venue"></div></div>B</td></tr><tr><td style= "border-bottom: 1px solid #ddd;" class="slot-2 slot-PL2C"><span class="slot-name"></span><div class="slot-deets"><span class="course-name"></span><div class="course-venue"></div></div>C</td></tr></table></td>
					<td class="slot-5 slot-5A"><span class="slot-name">5A</span><div class="slot-deets"><span class="course-name"></span><div class="course-venue"></div></div></td>
					<td class="slot-3 slot-3A"><span class="slot-name">3A</span><div class="slot-deets"><span class="course-name"></span><div class="course-venue"></div></div></td>
				</tr>
				<tr>
