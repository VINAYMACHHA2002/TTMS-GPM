<!-- LINKED WITH SYALLABUS\INFORMATION TECHNOLOGY\-->
<?php
...
IT_pdf's
	...
	<head>
		...
		<nav>
			...
			<fieldset>
			<legend style="font-size:30px"><b>CIRRICULLUM FOR IT DEPARTMENT</b></legend>
			<div class="container">
			<a href="/TTMS_GP_MUMBAI/pdf/IT/FY_FIRSTSEMESTER2016.pdf"><button type="submit" class = "btnf btn1">SEM_1.PDF</button></a><a href="/TTMS_GP_MUMBAI/pdf/IT/FY_SECONDSEMESTER2016.pdf"><button type="submit" class = "btns btn2">SEM_2.PDF</button></a><a href="/TTMS_GP_MUMBAI/pdf/IT/SY_THIRDSEMESTER2016.pdf"><button type="submit" class = "btnf btn1">SEM_3.PDF</button></a><br>
			<a href="/TTMS_GP_MUMBAI/pdf/IT/Sy_fourthsemester2016.pdf"><button type="submit" class = "btns btn2">SEM_4.PDF</button></a><a href="/TTMS_GP_MUMBAI/pdf/IT/IT16_SEM5.pdf"><button type="submit" class = "btnf btn1">SEM_5.PDF</button></a><a href="/TTMS_GP_MUMBAI/pdf/IT/SEM-6.pdf"><button type="submit" class = "btns btn2">SEM_6.PDF</button></a><br>
			</div>
			</fieldset>
		</body>
</html>